...
Instead of figuring out the conditions, I attempted running the binary this time.
...
Suddenly, I had another idea. Since the buffer that stores flag is on stack,
