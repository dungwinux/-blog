...
-   windbg executed correctly, but failed to render disassembly and AVX registers (WinAPI issue?)
-   lldb and gdb also could run program correctly and also failed to render AVX registers.
-   Only an [unofficial build](https://github.com/ssbssa/gdb) of gdb was able to detect AVX correctly
